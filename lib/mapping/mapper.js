 ...
 * query {Object} the query to apply as the scope
 */
Mapper.prototype.scope = function(prop, query) {
  this[prop] = this.ctor[prop] = applyScope.bind(undefined, this, query);
};
 ...
 * query {Object} the scope query to apply
 */
function applyScope(mapper, query) {
